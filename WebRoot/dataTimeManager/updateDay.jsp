  	...
  	<s:div align="center">
  		<s:form action="findDayAction" method="post">
		    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
		    	<tr>
		    		<td width="30%">
		    			<s:a href="http://localhost:8080/StrutsDome/dataTimeManager/addDay.jsp">增加日程</s:a>
		    		</td>
		    		<td width="30%">
			 ...
			 <%
			 		...
			 		for(int i=day.size()-1;i>=0;i--){
			 			...
			 			<tr>
							...
							<td width="50%">
								20<input type="text" size="1" name="year" 
											value="<%=token.nextToken() %>">年
		    					<input type="text" size="1" name="month"
		    								value="<%=token.nextToken() %>">月
		    					<input type="text" size="1" name="day"
		    								value="<%=token.nextToken() %>">日
							</td>
						</tr>
			 			<tr>
