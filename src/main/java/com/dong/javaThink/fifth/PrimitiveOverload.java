...
public class PrimitiveOverload {
    ...
    public static void main(String[] args) {
        PrimitiveOverload primitiveOverload = new PrimitiveOverload();
        primitiveOverload.testConstVal();
        primitiveOverload.testChar();
        primitiveOverload.testByte();
        primitiveOverload.testShort();
        primitiveOverload.testInt();
        primitiveOverload.testLong();
        primitiveOverload.testFloat();
    }
}
